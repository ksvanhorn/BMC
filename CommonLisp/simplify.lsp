...
(defparameter +zero+ (expr-const 0))
(defparameter +one+ (expr-const 1))
(defparameter +infty-pos+ (expr-const '%infty+))
(defparameter +infty-neg+ (expr-const '%infty-))
(defparameter +undef+ (expr-const '%undef))
(defparameter +true+ (expr-const 'true))
(defparameter +false+ (expr-const 'false))
